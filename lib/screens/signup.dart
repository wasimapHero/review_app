          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() => ElevatedButton(
                      onPressed: 
                          auth.isLoading.value ? null : () => auth.signUp(auth.emailController.text.trim(), auth.passController.text.trim()),
                    ...
                    // already registered
                    TextButton(onPressed: () => Get.toNamed(TRouteNames.loginScreen), child: Text('Already registered? then Login',  style: TextStyle(decoration: TextDecoration.underline),))
              ],
            ),
          ),
        ),
